...
namespace Particles
{
    ...
    public abstract class ParticleSystem : DrawableGameComponent
    {
            ...
            : base(game)
        {
            ...
            _defaultViewport = game.GraphicsDevice.Viewport;
        ...
        {
            if (_splitscreenRender)
            {
                if (_cameraOne != null)
                {
                    SetCamera(_cameraOne.View, _cameraOne.Projection);
                    DrawToViewport(_leftViewport);
                    SetCamera(_cameraTwo.View, _cameraTwo.Projection);
                    DrawToViewport(_rightViewport);
                }
            }
            else
            {
                SetCamera(_cameraOne.View, _cameraOne.Projection);
                DrawToViewport(_defaultViewport);
            }
        }

        public void SetSplitscreen(bool splitscreenEnabled)
        {
            _splitscreenRender = splitscreenEnabled;
        }

        private void DrawToViewport(Viewport viewport)
        {
            Viewport prevViewport = GraphicsDevice.Viewport;
        ...
        /// 
        /// NOTE: I made this private - this should now only be
        /// called internally
        /// --MSM
        /// </summary>
        ...
        public void SetCameras(Camera cameraOne, Camera cameraTwo)
        {
            _cameraOne = cameraOne;
            _cameraTwo = cameraTwo;
        }
        ...
        /// <summary>
        /// Updates the viewports for when the window size
        /// is changed.
        /// </summary>
        public void UpdateWindowSize(Viewport viewport)
        {
