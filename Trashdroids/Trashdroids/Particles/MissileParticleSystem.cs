...
{
    /// <summary>
    /// Custom particle system for creating a particle trail behind missiles.
    /// </summary>
    class MissileParticleSystem : ParticleSystem
    {
        public MissileParticleSystem(Game game, ContentManager content)
            : base(game, content)
        { }
